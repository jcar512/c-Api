...
namespace WebAPI.Migrations
{
    ...
    [Migration("20250707213534_first")]
    partial class first
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.ArtistasEspectaculo", b =>
                {
                    ...
                    b.HasKey("ArtistaId", "EspectaculoId");

                    b.HasIndex("EspectaculoId");

                    b.ToTable("ArtistasEspectaculos", (string)null);
                });
            ...
            modelBuilder.Entity("WebAPI.Models.ArtistasEspectaculo", b =>
                {
                    b.HasOne("WebAPI.Models.Artista", "Artista")
                        .WithMany("ArtistasEspectaculo")
                        .HasForeignKey("ArtistaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI.Models.Espectaculo", "Espectaculo")
                        .WithMany("ArtistasEspectaculo")
            ...
            modelBuilder.Entity("WebAPI.Models.Artista", b =>
                {
                    b.Navigation("ArtistasEspectaculo");
                });
